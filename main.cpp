...
int main(){
	...
	obj cube;
    cube.loadObject("/Users/utsavdhakal/Downloads/cube.obj");
    //cube.applyTransform(matrix('s', 100, 100, 100));
    cube.applyTransform(matrix('t', -0.5, -0.5,-0.5));
    cube.calculateNormals();

    obj teapot;
    teapot.loadObject("/Users/utsavdhakal/Downloads/teapot.obj");
    //teapot.applyTransform(matrix('s', 50, 50, 50));

    obj sphere;
    sphere.loadObject("/Users/utsavdhakal/Downloads/sphere.obj");
